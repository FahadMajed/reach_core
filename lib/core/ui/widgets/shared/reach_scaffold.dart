    ...
    return ModalProgressHUD(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: Form(
            key: formKey,
            child: withSafeArea ? SafeArea(bottom: button != null ? false : true, child: buildBody()) : buildBody(),
          ),
          bottomNavigationBar: isScrollable == false || resizeToAvoidBottomInset == false ? button : null,
        ),
      ),
    );
  }
