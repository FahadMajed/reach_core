...
class Formatter {
  static String formatChatId(String researcherId, String participantId) => "$researcherId+$participantId";

  static String formatTimeId() => Timestamp.now().microsecondsSinceEpoch.toString();
  ...
  static String formatDateTime(DateTime dateTime) => dateTime.toString().substring(0, 16);

  static String formatDate(DateTime dateTime) => dateTime.toString().substring(0, 10);
  ...
  static String formatStartingIn(String startDate) {
    ...
    if (startDateTime.difference(today).isNegative) {
      ...
      startingIn = '${"starting_in".tr} ${startDateTime.difference(today).inDays} ${"days".tr}';
    }
