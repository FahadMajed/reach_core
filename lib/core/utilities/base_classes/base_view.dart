...
import 'package:reach_core/core/core.dart' hide StateNotifierProvider;
...
abstract class ViewState<V extends View, ViewModel, Controller extends ViewController<ViewModel>>
...
abstract class Vieww<ViewModel, Controller extends ViewController<ViewModel>> extends ConsumerStatefulWidget {
  final bool observeRoute;
  final ProviderBase<ViewModel> viewModelPvdr;
  final ProviderBase<Controller> controllerPvdr;
  const Vieww(
