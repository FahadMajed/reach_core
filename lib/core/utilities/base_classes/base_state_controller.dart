...
abstract class AsyncListStateController<T> extends AsyncStateControIIer<List<T>> {
  void emitAdding(T element) => state = AsyncData([...list, element]);

  void emitRemoving(T element) => state = AsyncData([...list..remove(element)]);
